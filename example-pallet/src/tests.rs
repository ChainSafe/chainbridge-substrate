...
fn make_remark_proposal(hash: H256) -> Call {
    ...
    Call::Example(pallet_example::Call::remark { hash, resource_id })
}

fn make_transfer_proposal(to: u64, amount: u64) -> Call {
    let resource_id = HashId::get();
    Call::Example(pallet_example::Call::transfer {
        to,
        amount: amount.into(),
        resource_id,
    })
...
fn execute_remark() {
    mock::new_test_ext().execute_with(|| {
        ...
        mock::event_exists(pallet_example::Event::Remark(hash));
    })
}
...
fn create_sucessful_transfer_proposal() {
    mock::new_test_ext().execute_with(|| {
        ...
        mock::assert_events(vec![
            ...
            mock::Event::Bridge(chainbridge::Event::VoteAgainst(
            ...
            mock::Event::Bridge(chainbridge::Event::ProposalSucceeded(
                src_id, prop_id,
            )),
        ]);
    })
